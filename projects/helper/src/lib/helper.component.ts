...
@Component({
    standalone: true,
    selector: 'ngtw-helper',
    template: `

        <div class="drop-shadow-2xl w-full h-full">

            <div class="flex flex-col h-full border rounded-lg overflow-hidden drop-shadow-sm border-b-2">

                <div class="flex items-center bg-gray-400 h-14 w-full pr-3">

                    <div class="p-3">

                        <svg class="fill-gray-800 w-9 h-9" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path
                    ...
                    <div class="flex-1 text-gray-900 text-lg font-medium">
                    ...
                    <div class="">
                        ...
                        <svg class="fill-gray-300 cursor-pointer hover:fill-black w-6 h-6" clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex bg-gray-400 h-14 w-full drop-shadow-sm border-t-2">
