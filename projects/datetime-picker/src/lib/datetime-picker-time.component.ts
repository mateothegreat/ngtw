            ...
            <div class="flex flex-col items-end gap-y-2 bg-white rounded-lg p-4 shadow-xl border">
                ...
                <div class="flex gap-x-2 items-center">
                    <div class="flex flex-col items-center text-2xl">
                        ...
                        <div class="">
                            <input #hour autofocus value="12" maxlength="2" class="w-16 text-center text-2xl border-0 border-b-2 border-gray-300 focus:border-blue-400 focus:outline-none">
                        </div>
                    ...
                    <div class="flex flex-col items-center text-2xl">
                        ...
                        <div class="">
                            <input #minute value="00" maxlength="2" class="w-16 text-center text-2xl border-0 border-b-2 border-gray-300 focus:border-blue-400 focus:outline-none">
                        </div>
                        <div class="text-xs text-gray-300 pt-1">
                            MINUTE
                        </div>
                    ...
                    <div class="flex flex-col items-center text-2xl">
                        ...
                        <div class="">
                            <input #second value="00" maxlength="2" class="w-16 text-center text-2xl border-0 border-b-2 border-gray-300 focus:border-blue-400 focus:outline-none">
                        </div>
                        <div class="text-xs text-gray-300 pt-1">
                            SECOND
                        </div>
                ...
                <div class="">
                    <ngtw-button-group [buttons]="['AM', 'PM']" selected="AM"></ngtw-button-group>
                </div>
                <div class="mt-4 w-full">
                    <button [disabled]="false"
                            (click)="onSaveClick()"
                            class="w-full inline-flex justify-center items-center rounded-md border border-transparent disabled:bg-gray-400 bg-indigo-500 px-4 py-2 text-sm font-medium text-white shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                        Save selection
                    </button>
                </div>
            </div>
