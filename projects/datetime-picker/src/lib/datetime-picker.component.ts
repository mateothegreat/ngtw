            ...
            <div class="flex border-2 border-gray-200 rounded-lg overflow-hidden">
                <div class="w-44 flex flex-col p-2 border-r-2 border-gray-100 ">
                    ...
                    <div class="rounded-lg bg-violet-300 border border-violet-400 p-2 text-xs text-gray-600">
                        ...
                        <p>
                            asdf asd f asd fadfasf asdfasdf s
                ...
                <div class="h-[490px] flex flex-1 flex-col p-3">
                    ...
                    <div class="flex items-center gap-x-1 text-sm">
                        ...
                        <div (click)="timeShow('start')" class="bg-slate-200 border-2 border-gray-300 rounded-lg px-2 py-0.5 cursor-pointer hover:bg-indigo-200 hover:border-gray-400 transform active:scale-90 disabled:active:scale-100 transition-transform">
                        ...
                        <div class="bg-slate-200 border-2 border-gray-300 rounded-lg px-2 py-0.5">
                            <span class="font-medium mr-1">{{ formGroup.controls.end.value.date }}</span>
                        </div>
                        <div (click)="timeShow('end')" class="bg-slate-200 border-2 border-gray-300 rounded-lg px-2 py-0.5 cursor-pointer hover:bg-indigo-200 hover:border-gray-400 transform active:scale-90 disabled:active:scale-100 transition-transform">
                ...
                <div class="w-44 flex flex-col p-2 border-l-4 border-gray-100 bg-slate-50 shadow-inner">
                    <div class=""></div>
                    <div class="flex-1"></div>
                    <div class="">
                        <button (click)="onSaveClick()" class="w-full cursor-pointer inline-flex justify-center items-center rounded-md border border-transparent disabled:bg-gray-400 py-1.5 text-sm font-medium text-white shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" [class.bg-indigo-500]="formGroup.valid" [class.bg-gray-400]="!formGroup.valid">Save selection</button>
                    </div>
                </div>
            </div>
        </div>
